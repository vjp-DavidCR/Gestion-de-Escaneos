...
if [[ $2 -ne 1 ]]
then
dialog --backtitle "Proyecto Shell Script" --title "Escaneo de SERVICIOS → $1" --textbox temp10 0 0
...
dialog --backtitle "Proyecto Shell Script" --title "Resumen de SERVICIOS → $1" --textbox temp.txt 0 0
rm temp.txt
fi
rm temp10
